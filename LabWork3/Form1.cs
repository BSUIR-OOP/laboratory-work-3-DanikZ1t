...
namespace laba3
{
    public partial class Form1 : Form
    {
        ...
        private ISerialization BinarySerialization;
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void buttonSerialize_Click(object sender, EventArgs e)
        {
            ...
            BinarySerialization.Serialize(listOfPets,filename);
        }
        ...
        private void buttonDeserialize_Click(object sender, EventArgs e)
        {
            ...
            listOfPets.AddRange(BinarySerialization.Deserialize(filename)); 
            listBox1.Items.Clear(); //Thread.Sleep(1000); this.Refresh();
            ListShow(); 
        }
        ...
        private void ListShow()
        {
            ...
            {
                listBox1.Items.Add($"Type: {item.GetType().Name}, Name: {item.Name}, Age: {item.Age}, Color: {item.Color}"); //Thread.Sleep(1000);this.Refresh();
            }
        }
    }
}
